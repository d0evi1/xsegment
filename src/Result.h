...
#ifndef __ICTLAS_RESULT_H__
#define __ICTLAS_RESULT_H__
...
protected:
	bool    ChineseNameSplit(char *sPersonName,char *sSurname,
                         char *sSurname2,char *sGivenName,
                         CDictionary &personDict);
